...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("ProximaBot - Successfully imported " + shortname)
    else:
        import TelethonHell.utils
        ...
        LOGS.info("⚡ ProximaUserBot ⚡ - Successfully Imported " + shortname)
...
async def plug_channel(client, channel):
    if channel:
        LOGS.info("⚡ ProximaUserBot ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ ProximaUserBot ⚡ - Starting to load extra plugins.")
