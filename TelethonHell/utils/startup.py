...
async def logger_id(client):
    desc = "A Bot Logger Group For PROXIMASERBOT. DO NOT LEAVE THIS GROUP!!"
    try:
        grp = await client(
...
<b><i>»» <u><a href='https://t.me/proximaub'>▼△▼△   𝙿𝚁𝙾𝚇𝙸𝙼𝙰 𝚄𝙱 ▼△▼△</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("PROXIMA", "https://graph.org/PROXIMA-USERBOT-05-26")]],
    )
