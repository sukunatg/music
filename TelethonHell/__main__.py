...
# Global Variables #
HELL_PIC = "https://graph.org/file/b2b60feaa228fa9be281a.jpg"
...
async def start_hellbot():
    try:
        ...
        bot.tgbot = tbot
        LOGS.info("••• Starting ProximaUserBot (TELETHON) •••")
        ...
        LOGS.info("••• ProximauserBot Startup Completed •••")
        LOGS.info("••• Starting to load Plugins •••")
        await plug_load("TelethonHell/plugins/*.py")
        await plug_channel(bot, Config.PLUGIN_CHANNEL)
        LOGS.info("⚡ Your ProximaUB Is Now Working ⚡")
        LOGS.info("Head to @Proximaub for Updates. Also join chat group to get help regarding ProximaUserBot.")
