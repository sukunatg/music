...
my_channel = Config.MY_CHANNEL or "proximaub"
my_group = Config.MY_GROUP or "proximaub"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/proximaub"
hell_channel = f"[The ProximaUserBot]({chnl_link})"
grp_link = "https://t.me/proximaub"
hell_grp = f"[no support group for now]({grp_link})"
