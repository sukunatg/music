...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await hell.edit("Powered by frag!...")
    ...
    if len(text) <= 8:
        ...
        font_size_ = 130
        strik = 20
    await hell.edit("Making Beautiful wallpaper...")
...
CmdHelp("logos").add_command(
    "wallpaper", "gives random wallpapers pr text less images."
).add_info(
    "Wallpaper Maker."
).add_extra(
